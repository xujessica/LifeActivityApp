...
public class LunchFilterChoices extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lunch_filter_choices);
    }

    public void onApplyLunchFilterClick (View v) {
        Intent intent = new Intent(this, LunchFilterDisplayActivity.class);
